...
namespace Function
{
    ...
    public class FileHelper
    {
        ...
        /// <param name="Path">文件路径</param>
        /// <returns></returns>
        public static string ReadFile(string Path,System.Text.Encoding coding)
        {
            string s = "";;
            if (System.IO.File.Exists(Path))
            {
                StreamReader f2 = new StreamReader(Path, coding);//System.Text.Encoding.GetEncoding("gb2312")
                s = f2.ReadToEnd();
                f2.Close();
                f2.Dispose();
            }
