...
{
    /// <summary>
    ///指定的缩放模式 <see cref="CoolPrintPreviewControl"/> control.
    /// </summary>
    internal enum ZoomMode
    {
        ...
        TwoPages,
        /// <summary>
        /// 使用所指定的缩放因子<see cref="CoolPrintPreviewControl.Zoom"/> property.
        /// </summary>
        Custom
    }

    /// <summary>
    /// 代表了一个或两个网页预览<see cref="PrintDocument"/>.
    /// </summary>
    /// <remarks>
    /// 这种控制是类似的标准，<see cref="PrintPreviewControl"/> 但
    /// 它显示，因为它们呈现的页面。相比之下，标准控制 
    /// 等待，直到整个文档呈现之前，它显示任何。
    /// </remarks>
    internal class CoolPrintPreviewControl : UserControl
    {
        ...
        /// <summary>
        /// 初始化一个新的实例<see cref="CoolPrintPreviewControl"/> control.
        /// </summary>
        ...
        /// <summary>
        /// 获取或设置<see cref="PrintDocument"/> 被预览。
        /// </summary>
        ...
        /// <summary>
        /// 获取一个值，指示是否<see cref="Document"/> 正在呈现。
        /// </summary>
        ...
        /// <summary>
        ///获取或设置时使用自定义缩放因子 <see cref="ZoomMode"/> property
        ...
        /// <summary>
        /// 时发生的属性发生变化的价值<see cref="StartPage"/> 
        /// </summary>
        public event EventHandler StartPageChanged;
        /// <summary>
        /// Raises the <see cref="StartPageChanged"/> event.
        /// </summary>
        /// <param name="e"><see cref="EventArgs"/>提供事件数据。</param>
